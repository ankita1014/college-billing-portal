...
<form action="sign.php" method="post">
    <div class="container">
        <div class="left">
          ...
          <div class="form">
            <input type="username" class="form-field animation a3" placeholder="Username" name="username">
...
<html >
  ...
  <body  style="background-image: linear-gradient(to top, #5ee7df 0%, #b490ca 100%);">
