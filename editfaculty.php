  ...
  function menuBtnChange() {
   if(sidebar.classList.contains("open")){
    ...
    <section id="content">
        ...
        <!-- MAIN -->
        <main>
            <h1 class="title"> Edit Faculty Details</h1>
            <ul class="breadcrumbs">
                <li><a href="dashboard.php">Home</a></li>
                <li class="divider">/</li>
                
                <li><a href="editfaculty.php" class="active"> Edit Faculty Details</a></li>
            </ul>
            <div class="data">
            ...
            if (isset($_POST['dbbtn'])) {
                $mobno = $_POST['mobno'];
                $_SESSION['mob'] = $mobno;
                $sql = "SELECT *FROM faculty_details WHERE phone ='$mobno'";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    <div class="data">
                        <div class="content-data">
                            <form class="form" method='post' action='updatefaculty.php'>
                            <div class="form-control">
                                <label>Faculty Name</label>
                                <input type="text" name="facultyname" value="<?php if (isset($_POST['mobno'])) {
                            ...
                            <input type="email" name="facultyfmail" value="<?= $row['facultymail']?>" id="">
                        </div>
                            <div class="form-control">
                    ...
                    echo '<script>swal("Error!","No Record Found","error").then((value) => location.href="editfaculty.php");</script>';
                    exit;
                }
            }
